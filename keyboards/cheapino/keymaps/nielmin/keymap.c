...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_3(
        ...
        KC_Z, KC_X, KC_C, KC_D, KC_V,                   KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH,
            MO(1), KC_SPC, KC_TAB,                          MT(MOD_RSFT, KC_ENT), LT(3, KC_BSPC), MO(2)
    ),
    [1] = LAYOUT_split_3x5_3(
        ...
        KC_NO, TG(4), KC_NO, KC_NO, KC_CAPS,                                    KC_NO, KC_BSPC, KC_TAB, KC_NO, KC_ENT,
    ...
    [4] = LAYOUT_split_3x5_3(
        ...
        KC_LALT, KC_Z, KC_X, KC_C, KC_V,                KC_B, KC_N, KC_M, KC_COMM, KC_DOT,
            MO(5), KC_SPC, KC_LSFT,                         KC_ENT, KC_BSPC, MO(2)
    ),
    [5] = LAYOUT_split_3x5_3(
        KC_ESC, KC_1, KC_2, KC_3, KC_4,                 KC_Y, KC_U, KC_I, KC_O, KC_P,
        KC_P, KC_O, KC_N, KC_M, KC_G,                   KC_G, KC_H, KC_J, KC_K, KC_L,
        KC_LSFT, TG(4), KC_X, KC_M, KC_B,               KC_B, KC_N, KC_M, KC_COMM, KC_DOT,
